...
use Dullahan\src\Contract\NotDoubleSubmitAuthenticatedController;
use Dullahan\src\Contract\NotTokenAuthenticatedController;
    ...
    protected function validateRoutesAccess(string $path): void
    {
        if (preg_match('/^\/(_\/user)/', $path)) {
            ...
            if (!$this->security->isGranted('ROLE_USER')) {
                throw new AccessDeniedHttpException('You need to be an user in to access this resource');
            }
        }
    }
