...
use Dullahan\Entity\Presentation\Event\Transport\OwnershipCheck;
...
use Dullahan\Entity\Presentation\Event\Transport\PostValidationCreate;
use Dullahan\Entity\Presentation\Event\Transport\PostValidationUpdate;
...
use Dullahan\Entity\Presentation\Event\Transport\Retrieval;
    ...
    public function getEntityDefinition(object $entity): array
    {
        ...
        if ($item->isHit()) {
            ...
            $definition = json_decode(
                json_encode(
                    (new FieldReader($entity, $this->cacheService, $this->cacheService->getCache()))->getFields($this->getEntityTrueClass($entity))
                ) ?: '',
                true
            );
